...
export const SUPPORTED_TOKENS: SupportedToken[] = [
  ...
  // resolves the indexer's tokenSymbol instead of falling back to SUPPORTED_TOKENS[0] (BTC).
  // Decimals are the on-chain coin metadata: SUI=9, DUSD/XUSD=9.
  {
    symbol: "SUI",
    name: "Sui",
    decimals: 9,
    ...
    unit: "SUI",
    priceKey: "sol",
    shieldedSymbol: "zkSUI",
    shieldedLogo: "/tokens/sui.png",
    explorerFilter: "sol",
    showRawAmount: false,
    explorerColors: {
      from: "text-sui/70 bg-sui/6 border-sui/10",
      to: "text-privacy/80 bg-privacy/6 border-privacy/10",
    },
    explorerLabel: "SUI",
    explorerSubtitle: "Sui",
    relayerFee: 0,
  },
  {
    symbol: "XUSD",
    ...
    explorerLabel: "XUSD",
    explorerSubtitle: "Sui Stablecoin",
    relayerFee: 0,
  },
  {
    symbol: "DUSD",
