 ...
 * carries a complete `sns` block and a Solana RPC URL. The UI remains
 * network-scoped; this guard governs backend availability, not what the UI
 * shows. Networks without SNS configured are rejected.
 */
